...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8164290649:AAHfcvHoGdHv53wTO5-tgKsRoQeruuzsXHo")
APP_ID = int(os.environ.get("APP_ID", "21255401")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "5afa4e413bba25aadc6cdcd857804a84") #Your API Hash from my.telegram.org
#--------------------------------------------
